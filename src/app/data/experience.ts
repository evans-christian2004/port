...
export const experiences: experience[] = [
    ...
    },
    {
        ...
        description:
            "Provide Tier 1 technical support for UCF's largest IT zone, assisting over 500 students, faculty, and staff. Manage Active Directory operations, handle hardware lifecycle tasks, and automate IT processes to improve resolution efficiency and service quality. Work was tracked using ServiceNow as a ticketing system, where I routinely led my zone in tickets resolved and client satisfaction.",
        responsibilities: [
    ...
    },
    {
        ...
        description:
            "Lead a team of consultation agents to deliver exceptional customer service and technical support for complex software, hardware, and network issues. I oversaw client consultations, managed escalations, and maintained service quality with a focus on clear communication and problem resolution. Clear technical communication skills and team collaboration were vital to my role as a Geeksquad Agent.",
        responsibilities: [
