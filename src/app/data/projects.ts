...
const projects: project[] = [
    ...
    },
    {
        ...
        bodyText: "Miami has a lot to offer, and I wanted to show off my bustling home. As my first React project, I use the framework to show off some of the amazing sites and activities that can be done in Miami, Florida",
        images: [
