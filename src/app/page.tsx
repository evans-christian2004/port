          ...
          <div className="flex lg:flex-row flex-col-reverse items-center">
            <div className="px-6 lg:px-12 text-xl">
              ...
              <p className="text-sm sm:text-xl">
                Hello and welcome! My name is <strong className="landing">Christian Evans</strong>, and I&apos;m a <strong className="landing">software engineer and IT technician studying Information Technology</strong> at the <Link href="https://www.ucf.edu/" className="text-primary-500 underline">
              ...
              <p className="text-sm sm:text-xl pt-6">
                Professionally, I currently work at <Link href="https://it.ucf.edu/" className="text-primary-500 underline">UCF&apos;s IT department</Link> as an IT Student Technician, where I Provide <strong className="landing">Tier 1 technical Support for UCF&apos;s largest IT zone</strong>. 
                I provide support for over 500 students, faculty, and staff.
              </p>
              <p className="text-sm sm:text-xl pt-6">
                Previously, I was a <strong className="landing">front-end engineer intern</strong> for <Link href="https://thestartuplife.io/" className="text-primary-500 underline">The Startup Life</Link>, an LLC based in Miami with the goal of growing the digital brand of different small organizations
